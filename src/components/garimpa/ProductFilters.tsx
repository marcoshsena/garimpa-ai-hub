...
export function ProductFilters({
  ...
  return (
    <div className="rounded-xl border bg-card p-4 shadow-sm">
      <div className="mb-3 flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-brand-navy">
        <SlidersHorizontal className="h-3.5 w-3.5 text-brand-orange" />
        Filtros
      </div>
      <div className="grid gap-3 md:grid-cols-[1.5fr_1fr_1fr_1fr_1.2fr]">
        <div>
